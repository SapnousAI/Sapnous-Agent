...
def get_llm_model(provider: str, **kwargs):
    ...
    if provider == "anthropic":
        ...
        return ChatOpenAI(
            model=kwargs.get("model_name", "google/gemini-2.5-pro-exp-03-25:free"),
            temperature=kwargs.get("temperature", 0.0),
            base_url=base_url,
        ...
        if not kwargs.get("base_url", ""):
            base_url = os.getenv("MISTRALAI_ENDPOINT", "https://api.mistral.ai/v1")
        else:
            base_url = kwargs.get("base_url")

        return ChatMistralAI(
            model=kwargs.get("model_name", "mistralai/mistral-small-3.1-24b-instruct:free"),
            temperature=kwargs.get("temperature", 0.0),
            base_url=base_url,
            api_key=kwargs.get("api_key", "") or os.getenv("MISTRALAI_API_KEY", ""),
        )
